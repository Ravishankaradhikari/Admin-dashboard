...
const Main = () => {
  return (
    <div className="px-[25px] pt-[25px] bg-[#ffffb8] pb-[40px]">
      <div className="flex items-center justify-between">
        <h1 className="text-[28px] leading-[34px] font-normal text-[#5a5c69] cursor-pointer">
          Dashboard
        </h1>

        <button className="bg-[#08979c] h-[32px] rounded-[3px] text-black flex items-center justify-center px-[8px]">
          Generate Report
        </button>
      </div>
      ...
      <div className="flex mt-[22px] w-full gap-[30px]">
        <div className="w-[76%] border bg-[#fff1f0] shadow-md cursor-pointer rounded-[4px]">
        ...
        <div className="w-[23.8%] border bg-[#fff1f0] shadow-md cursor-pointer rounded-[4px]">
          <div className="bg-[#F8F9FC] flex items-center justify-between py-[15px] px-[5px] border-b-[1px] border-[#EDEDED]">
            <h2 className="text-[#4e73df] text-[16px] leading-[19px] font-bold">
              Revenue Resources
            </h2>
            <FaEllipsisV color="gray" className="cursor-pointer" />
      ...
      <div className="flex mt-[22px] w-full gap-[30px]">
        <div className="basis-[55%] border bg-[#fff1f0] shadow-md cursor-pointer rounded-[4px]">
        ...
        <div className="basis-[45%] border bg-[#fff1f0] shadow-md cursor-pointer rounded-[4px]">
          <div className="bg-[#F8F9FC] flex items-center justify-between py-[15px] px-[20px] border-b-[1px] border-[#EDEDED]">
            <h2 className="text-[#4e73df] text-[16px] leading-[19px] font-bold">
              {" "}
              Resources
