        ...
        <div className=''>
            <div className='flex items-center justify-between h-[70px] shadow-lg px-[25px] '>
                <div className='flex items-center rounded-[5px]'>
                    ...
                    <div className='bg-[#5cdbd3] h-[40px] px-[14px] flex items-center justify-center cursor-pointer rounded-tr-[5px] rounded-br-[5px]'>
                ...
                <div className='flex items-center gap-[20px]'>
                    ...
                    <div className='flex items-center gap-[15px] relative' onClick={showProfile} >
                        <p><b>Ravi Shankar Adhikari</b></p>
                        <div className='h-[50px] w-[50px] rounded-full bg-[#95de64] cursor-pointer flex items-center justify-center relative z-40' >
                            <img src={profile} alt="" />
